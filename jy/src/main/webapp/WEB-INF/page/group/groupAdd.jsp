...
<body>
	...
	<div>
		...
		<div id="container" class="content">
			<!-- 表单开始 -->
			<form action="${base}/groups" class="form-horizontal" id="commForm">
				<!-- 待编辑区 panel开始 -->
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea rows="10" cols="5" class="form-control" id="gDetail" name="gDetail"></textarea>
	...
	<!--自定义JS-->
	<script src="${resourcesUrl}/js/group/groupAdd.js"></script>
</body>
</html>
